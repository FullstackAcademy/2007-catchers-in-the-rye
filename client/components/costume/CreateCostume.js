...
class CreateCostume extends Component {
  ...
  submitCostume(ev) {
    ...
    const {
      costumeName, price, quantity, imageUrl, categoryId,
    } = state;
  ...
  render() {
    const {
      state, props, submitCostume, handleChange,
    } = this;
    const {
      costumeName, price, quantity, imageUrl, categoryId,
    } = state;
    ...
    return (
      <div>
        ...
        <form onSubmit={submitCostume}>
          ...
          <input name="costumeName" type="text" value={costumeName} onChange={handleChange} />
          <br />
          <br />
